...
class store_goods_onlineControl extends BaseSellerControl {
    ...
    public function edit_save_goodsOp() {
        ...
        $update_common['goods_type']         = $_POST['goods_type'];
        $update_common['rebate']             = $_POST['rebate'];
        ...
        if (is_array ( $_POST ['spec'] )) {
            foreach ($_POST['spec'] as $value) {
                ...
                if (!empty($goods_info)) {
                    ...
                    $update['goods_type']        = $update_common['goods_type'];
                    $update['rebate']            = $update_common['rebate'];
		    ...
		    // 生成商品二维码
                    ...
                    $insert['goods_type']        = $update_common['goods_type'];
                    $insert['rebate']            = $update_common['rebate'];
