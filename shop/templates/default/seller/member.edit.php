  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label>推荐人类别:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="inform_allow1" class="cb-enable <?php if($output['member_array']['inform_allow'] == '1'){ ?>selected<?php } ?>" ><span>普通</span></label>
            <label for="inform_allow2" class="cb-disable <?php if($output['member_array']['inform_allow'] == '2'){ ?>selected<?php } ?>" ><span>特殊</span></label>
          ...
          <td class="vatop tips">普通推荐人:获取直系下级的返利;特殊推荐人:获取所有下级的返利</td>
        </tr>

        <tr>
            <td colspan="2" class="required"><label>是否顶级推荐人:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform onoff">
                <label for="inviter_id1" class="cb-enable <?php if($output['member_array']['inviter_id'] == null){ ?>selected<?php } ?>" ><span>是</span></label>
