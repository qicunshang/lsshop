        ...
        <dl nctype="nc-spec">
          ...
          <dd>
            ...
            <ul nctyle="ul_sign">
              ...
              <?php }else{?>
              <!-- 文字类型规格-->
              <li class="sp-txt"><a href="javascript:void(0)" class="<?php if (isset($output['goods']['goods_spec'][$k])) { echo 'hovered';} ?>" data-param="{valid:<?php echo $k;?>}"><?php echo stripslashes($v);?><i></i></a></li>
              <?php }?>
              <?php }?>
            </ul>
            <?php }?>
